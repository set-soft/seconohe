...
#
# Project: https://github.com/pymatting/pymatting
#
# License: MIT
#
# Implementation by: Thomas Germer, Tobias Uelwer, Joseph Adam, Christian Clauss
#
# CUDA implementation using CuPy
# It needs a full CUDA environment
#
import numpy as np
import cupy as cp
